        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/admin/home') }}">
                <div class="sidebar-brand-icon">
                    <img src="{{ asset('images/1.png') }}" style="width:35px" alt="logo-villamerah-siakad">
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/tambah_siswa">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="https://econtrolling.jatengprov.go.id/themes/images/user.png">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Sistem Informasi Akademik <a href="http://villamerah.com"
                                target="_blank">Villa Merah</a> 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
